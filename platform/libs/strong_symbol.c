...
#if !BT_SNDP_DUMP_EN && !BT_AEC_DUMP_EN && !BT_SCO_FAR_DUMP_EN   && !BT_AINS2_DUMP_EN
...
AT(.com_text.sndp)
void dma_sndp_sl_process(s16 *buf){}
#endif
...
#if !BT_SCO_DMNS_EN
int dmns_process(s16 *data,s16 *data2){return 0;}
void dmns_init(u32 nt){}
...
void sdadc_drc_soft_gain_proc(s16 *ptr, u32 samples) {}
#endif
