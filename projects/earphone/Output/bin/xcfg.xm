...
config(BYTE, "拾音角度", "通话的拾音角度（与双麦之间的连线左右两边形成的夹角（10-89度 步进5度）），如果耳机佩戴位置变化大，建议加大角度", BT_SNDP_DM_DEGREE, 0, 16, 10, BT_SNDP_DM_EN);
...
config(NUM, "响应限幅", "最大冲击响应限幅，声加工具会给一个参考值，也是最大值，越大收敛越快，超过参考值会导致间断失音", BT_SNDP_DM_MAXIR, 0, 262144, 97150, BT_SNDP_DM_EN);
