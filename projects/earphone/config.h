...
#define GUI_SELECT                      GUI_LEDSEG_5P7S                  //GUI Display Select
...
#define BT_FOT_EN                       0   //蓝牙双备份升级，通过SPP或BLE协议连接APP，需要根据使用的flash大小对应修改上面的FLASH_SIZE，程序大小需要限制在（FLASH_SIZE/2 - 12）K以内
...
#define BT_SCO_FAR_NR_SELECT            0   //0：ans 1：ains2
...
#define BT_SCO_CALLING_NR_EN            0   //是否打开电话呼出，铃声响起之前做个动态降噪
