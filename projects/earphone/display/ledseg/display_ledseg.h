...
#include "ledseg/ledseg_5p7s.h"
#define ledseg_init()               ledseg_5p7s_init()
#define ledseg_off()                ledseg_5p7s_off()
#define ledseg_scan()               ledseg_5p7s_scan()
#define ledseg_update_dispbuf()     ledseg_5p7s_update_dispbuf()
#elif (GUI_SELECT == GUI_LEDSEG_7P7S)
