...
{
#if FUNC_AUX_EN && (GUI_SELECT != GUI_LEDSEG_5P7S)
    if (is_mute_flicker()) {
        return;
    }
    ledseg_buf[1] = T_LEDSEG_A;
...
{
#if FUNC_SPEAKER_EN && (GUI_SELECT != GUI_LEDSEG_5P7S)
    if (is_mute_flicker()) {
        return;
    }
...
{
#if FUNC_CLOCK_EN && (GUI_SELECT != GUI_LEDSEG_5P7S)
...
{
#if FUNC_REC_EN && (GUI_SELECT != GUI_LEDSEG_5P7S)
    u8 sec, minute;
...
{
#if REC_AUTO_PLAY && (GUI_SELECT != GUI_LEDSEG_5P7S)
...
{
#if FUNC_FMAM_FREQ_EN && (GUI_SELECT != GUI_LEDSEG_5P7S)
    if (fmam_freq > 9999) {
