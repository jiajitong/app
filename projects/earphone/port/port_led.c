...
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_poweron     = {0x00, 0xff, 1, 0};   //���Ƴ���
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_poweroff    = {0x00, 0x00, 0, 0};   //��ƣ������ￄ1�7
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_idle        = {0x00, 0xff, 1, 0};   //���Ƴ���
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_btinit      = {0x00, 0xaa, 10, 0};  //����500ms������˸��Ĭ�ϸ�w4pwrkeyһ��
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_pairing     = {0x60, 0x03, 3, 6};   //��300ms��450ms�����콻����
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_reconnect   = {0x00, 0xaa, 6, 0};   //����300ms������˸
AT(.rodata.led.cfg)
...
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_calling     = {0x00, 0x0a, 2, 86};  //��100ms, ��5S, ������
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_music_busy  = {0x00, 0xaa, 4, 0};   //����200ms���ڿ���˸
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_music_play  = {0x00, 0xaa, 20, 0};  //����1s������˸
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_aux_play    = {0x00, 0xaa, 20, 0};  //����1s������˸
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_fm_play     = {0x00, 0xaa, 20, 0};  //����1s������˸
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_fm_scan     = {0x00, 0xaa, 20, 0};  //����1s������˸
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_record      = {0x00, 0xaa, 20, 0};  //����1s������˸
AT(.rodata.led.cfg)
const led_cfg_t led_cfg_pb_sleep    = {0x00, 0x02, 1, 92};  //ÿ5����50ms
...
u8 led_get_cfg_port(void)
{
    if(xcfg_cb.led_disp_en) {
        ...
        return xcfg_cb.rled_io_sel; //���ѡ���ￄ1�7
    }
    return 0;                       //����ʾ
}
#endif
